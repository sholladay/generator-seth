...
**Important work** comes in many forms. There are labels for [bugs](<%= repoUrl %>/labels/bug) and [easy](<%= repoUrl %>/labels/easy) vs [hard](<%= repoUrl %>/labels/hard) tasks. We also appreciate documentation, examples, tutorials, blogs, videos, books, and other supporting content.
